# Contributing to EpiRank

Thank you for your interest in contributing to EpiRank! This document provides guidelines for contributing to this project.

## How to Contribute

### Reporting Issues

- Use the [GitHub Issues](https://github.com/canslab1/EpiRank/issues) page to report bugs or request features.
...
python EpiRank_GUI.py  # Verify the GUI launches correctly
```
